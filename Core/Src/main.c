...
/* Configure the peripherals common clocks */
  ...
  MX_I2S4_Init();
  /* USER CODE BEGIN 2 */
  HAL_ADC_Start_DMA(&hadc1, AudioIn, 2);
  ...
  {
    /* USER CODE END WHILE */
	  HAL_I2S_Transmit_DMA(&hi2s1, AudioCh1, 1);
	  HAL_I2S_Transmit_DMA(&hi2s2, AudioCh2, 1);
	  HAL_I2S_Transmit_DMA(&hi2s3, AudioCh3, 1);
	  HAL_I2S_Transmit_DMA(&hi2s4, AudioCh4, 1);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
}
